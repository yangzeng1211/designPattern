...
//        String FileName1 = "src/com/demo2/Picture/" + Cuprum + ".jpg";
//        String FileName2 = "src/com/demo2/Picture/" + paper + ".jpg";
        String FileName1 = null;
        String FileName2 = null;
        try {
            FileName1 = URLDecoder.decode(MaterialWin.class.getResource("Picture/"+Cuprum+".jpg").getPath(), "UTF-8");
            FileName2 = URLDecoder.decode(MaterialWin.class.getResource("Picture/"+paper+".jpg").getPath(), "UTF-8");
