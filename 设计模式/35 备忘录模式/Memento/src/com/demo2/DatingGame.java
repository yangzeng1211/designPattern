...
//        FileName = "src/com/demo2/Photo/四大美女.jpg";
        try {
            FileName = URLDecoder.decode(DatingGameWin.class.getResource("Photo/四大美女.jpg").getPath(), "UTF-8");
...
//        FileName = "src/com/demo2/Photo/" + name + ".jpg";
        try {
            FileName = URLDecoder.decode(DatingGameWin.class.getResource("Photo/"+name+".jpg").getPath(), "UTF-8");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        g = new JLabel(new ImageIcon(FileName), JLabel.CENTER);
