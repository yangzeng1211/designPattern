...
//        String FileName = "src/com/demo2/Picture/" + Name + ".jpg";
        String imagePath = null;
        try {
            imagePath = URLDecoder.decode(PictureFrame.class.getResource("Picture/"+Name+".jpg").getPath(), "UTF-8");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        JLabel lb = new JLabel(Name, new ImageIcon(imagePath), JLabel.CENTER);
