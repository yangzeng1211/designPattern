...
class WySpecialty extends JPanel implements TreeSelectionListener {
    ...
    private ImageIcon s1(){
        ...
        try {
            imageIcon = new ImageIcon(URLDecoder.decode(WySpecialty.class.getResource("WyImage/Specialty11.jpg").getPath(), "UTF-8"));
    ...
    private ImageIcon s2(){
        ImageIcon imageIcon = null;
        try {
            imageIcon = new ImageIcon(URLDecoder.decode(WySpecialty.class.getResource("WyImage/Specialty12.jpg").getPath(), "UTF-8"));
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        return imageIcon;
    ...
    private ImageIcon s3(){
        ImageIcon imageIcon = null;
        try {
            imageIcon = new ImageIcon(URLDecoder.decode(WySpecialty.class.getResource("WyImage/Specialty13.jpg").getPath(), "UTF-8"));
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        return imageIcon;
    ...
    private ImageIcon s4(){
        ImageIcon imageIcon = null;
        try {
            imageIcon = new ImageIcon(URLDecoder.decode(WySpecialty.class.getResource("WyImage/Specialty14.jpg").getPath(), "UTF-8"));
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        return imageIcon;
    ...
    private ImageIcon s5(){
        ImageIcon imageIcon = null;
        try {
            imageIcon = new ImageIcon(URLDecoder.decode(WySpecialty.class.getResource("WyImage/Specialty21.jpg").getPath(), "UTF-8"));
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        return imageIcon;
    ...
    private ImageIcon s6(){
        ImageIcon imageIcon = null;
        try {
            imageIcon = new ImageIcon(URLDecoder.decode(WySpecialty.class.getResource("WyImage/Specialty22.jpg").getPath(), "UTF-8"));
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        return imageIcon;
    ...
    private ImageIcon s7(){
        ImageIcon imageIcon = null;
        try {
            imageIcon = new ImageIcon(URLDecoder.decode(WySpecialty.class.getResource("WyImage/Specialty23.jpg").getPath(), "UTF-8"));
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        return imageIcon;
    ...
    private ImageIcon s8(){
        ImageIcon imageIcon = null;
        try {
            imageIcon = new ImageIcon(URLDecoder.decode(WySpecialty.class.getResource("WyImage/Specialty24.jpg").getPath(), "UTF-8"));
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        return imageIcon;
